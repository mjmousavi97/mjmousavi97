...
I build and analyze **machine learning**, **deep learning**, and **graph-based** models—especially for **image processing** and data-driven modeling—with a strong interest in **interpretable AI** and **graph learning**.

- 📍 Tehran, Iran  
- 🔎 Current thesis: **Brain Age Estimation using fMRI-based functional connectivity graphs** (graph learning / GNN pipelines).
...
- GitHub: https://github.com/mjmousavi97
